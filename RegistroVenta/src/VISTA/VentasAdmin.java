...
public class VentasAdmin extends javax.swing.JFrame {
            ...
            if(!"Seleccione un cliente...".equals(codClient.getSelectedItem())){
                if(modelo.getRowCount() > 0){
                    ...
                    if(pregunta == 0){
                        ...
                        NewVentaAdmin vta = new NewVentaAdmin(datosSeleccionados, nomEmple, nomClient, totalP, codP);
                        vta.setVisible(true);
    ...
    private void initComponents() {
        ...
        añadir.setBackground(new java.awt.Color(81, 141, 5));
        ...
        codClient.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
        ...
        codEmple.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
        ...
        materialMueble.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
        jPanel1.add(materialMueble);
        materialMueble.setBounds(880, 200, 250, 40);

        cant.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
        jPanel1.add(cant);
        cant.setBounds(880, 350, 250, 40);

        nomMueble.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
        jPanel1.add(nomMueble);
        nomMueble.setBounds(880, 100, 250, 40);

        categMueble.setEditable(false);
        categMueble.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
        jPanel1.add(categMueble);
        categMueble.setBounds(880, 150, 250, 40);

        stokMueble.setEditable(false);
        stokMueble.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
        ...
        pressMueble.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
