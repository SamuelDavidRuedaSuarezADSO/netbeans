...
public class MueblesAdmin extends javax.swing.JFrame {
    ...
    public void Eliminar(){
        if(!"".equals(codigo.getText())){
            ...
            JOptionPane.showMessageDialog(null, "ERROR: SELECCIONA un mueble");
        }
    }
    ...
    private void initComponents() {
        ...
        codigo.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
        jPanel1.add(codigo);
        ...
        categoria.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
        ...
        colorMueble.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MueblesAdmin().setVisible(true);
            }
        });
    }
