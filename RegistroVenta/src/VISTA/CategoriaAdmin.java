...
public class CategoriaAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CodCategoria.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
        jPanel1.add(CodCategoria);
        CodCategoria.setBounds(870, 240, 270, 40);

        NomCategoria.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
        ...
        jScrollPane2.setBounds(330, 410, 780, 240);
        ...
        ZonaCategoria.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(81, 141, 5)));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CategoriaAdmin().setVisible(true);
            }
        });
    }
